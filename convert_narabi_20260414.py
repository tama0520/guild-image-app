...
def make_title(run_indices):
    ...
    N = len(run_indices)
    unique = [m.strip() for m in machines_ordered]  # タイトル用にstrip
...
for run_idx, run in enumerate(runs):
    ...
    # part2 を part1 の直後に GAP_SUM だけ詰めて描画
    ...
    print(f"  -> {out_path}")
    print(f"     quality={best_quality}, {final_size//1024}KB")
